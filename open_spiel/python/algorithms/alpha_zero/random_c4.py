...
_GAME_TYPE = pyspiel.GameType(
    short_name="python_randomized_connect_four",
    long_name="Python Randomized Connect Four",
...
class RandomConnectFour(pyspiel.Game):
    ...
    def new_initial_state(self):
        ...
        return RandomConnectFourState(self.game)
...
class RandomConnectFourState(pyspiel.State):
    ...
    def _apply_action(self, action):
        ...
        if self.__pyspiel_game_state.is_terminal():
            ...
            outcome = np.random.randn().round(2)
            self._returns[player_id] = outcome
            self._returns[1 - player_id] = -outcome
    ...
    def clone(self):
        ...
        new_state = RandomConnectFourState(self.__pyspiel_game_)
...
pyspiel.register_game(_GAME_TYPE, RandomConnectFour)
