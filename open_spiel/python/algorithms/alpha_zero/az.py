...
flags.DEFINE_integer("checkpoint_freq", 50, "Save a checkpoint every N steps.")
flags.DEFINE_integer("actors", 10, "How many actors to run.")
flags.DEFINE_integer("evaluators", 10, "How many evaluators to run.")
...
flags.DEFINE_integer("max_steps", 500, "How many learn steps before exiting.")
